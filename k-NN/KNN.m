...
%
% Synopsis
%   [Class] = KNN(X, Proto, ProtoClass, [K], [distFunc])
%
% Description
...
function [Class, Rank] = KNN(X, Proto, ProtoClass, K, distFunc)
